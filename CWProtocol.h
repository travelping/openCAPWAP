...
#ifdef PA_EXTENSION
#define     CW_NEIGHBORDEAD_INTERVAL_DEFAULT    40
#define     CW_NEIGHBORDEAD_RESTART_DISCOVERY_DELTA 20
#else
#ifdef CW_DEBUGGING
#define     CW_NEIGHBORDEAD_INTERVAL_DEFAULT    70
#define     CW_NEIGHBORDEAD_RESTART_DISCOVERY_DELTA 40
#else
#define     CW_NEIGHBORDEAD_INTERVAL_DEFAULT    70
#define     CW_NEIGHBORDEAD_RESTART_DISCOVERY_DELTA 40
#endif
...
#define     CW_DATA_CHANNEL_KEEP_ALIVE_DEFAULT  5
#else
#define     CW_ECHO_INTERVAL_DEFAULT        5
#define     CW_DATA_CHANNEL_KEEP_ALIVE_DEFAULT  5
#endif
